...
insert into Admins (admin_Name, admin_Surname, admin_PhoneNumber, company_ID)
values	('Jim', 'Adams', '0832965736', '001'),
		('Bob', 'Stevens', '0735992902', '001'),
        ('Mandy', 'Shore', '0846863495', '001');

insert into Dispatch (dispatch_Name, dispatch_Surname, dispatch_PhoneNumber, company_ID)
values	('Adam', 'Jones', '0842139879', '001'),
		('Eve', 'Stones', '0734672953', '001'),
        ('John', 'Mecury', '0716623845', '001');
...
insert into Staff (staff_Name, staff_Surname, staff_PhoneNumber, store_ID)
values	('James', 'Jameson', '0831252543', '002'),
		('Mary', 'Scarlet', '0847285377', '001'),
        ('Amy', 'Hendricks', '0712993475', '003');
